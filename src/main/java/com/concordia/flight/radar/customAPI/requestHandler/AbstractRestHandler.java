...
import com.concordia.flight.radar.customAPI.restApi.RestErrorInfo;
import com.concordia.flight.radar.exceptions.ResourceNotFoundException;
...
public abstract class AbstractRestHandler implements ApplicationEventPublisherAware {
	...
	protected final Logger log = Logger.getLogger(AbstractRestHandler.class);
	...
	public @ResponseBody RestErrorInfo handleDataStoreException(DataFormatException ex, WebRequest request,
		...
		log.error("Converting Data Store exception to RestResponse : " + ex.getMessage(), ex);
	...
	public @ResponseBody RestErrorInfo handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request,
			HttpServletResponse response) {
		log.error("ResourceNotFoundException handler:" + ex.getMessage(), ex);
